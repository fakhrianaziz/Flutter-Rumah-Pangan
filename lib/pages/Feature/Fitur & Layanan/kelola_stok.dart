...
class FKelolaStok extends StatefulWidget {
  @override
  _FKelolaStokState createState() => _FKelolaStokState();
}

class _FKelolaStokState extends State<FKelolaStok> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text(STRTitle.stockPage),
